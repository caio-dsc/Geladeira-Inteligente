...
export const LoginView: React.FC<LoginViewProps> = ({
  ...
  return (
    <div className="min-h-screen bg-surface-muted text-text-primary flex flex-col justify-between selection:bg-primary/20 selection:text-primary relative overflow-x-hidden font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="font-bold text-xs shadow-subtle cursor-pointer transition-all duration-200 hover:ring-2 hover:ring-primary/20"
            >
              Entrar agora
            </Button>
          </div>
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3.5">
            <Button
              ...
              size="lg"
              onClick={openAuthModal}
              className="font-bold text-sm sm:text-base px-8 py-3.5 shadow-soft hover:shadow-elevated hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 cursor-pointer motion-reduce:transform-none ring-2 ring-primary/20 hover:ring-4 hover:ring-primary/30"
            >
              Entrar agora
            </Button>
      ...
      {/* ===================================================================== */}
      {/* BOTTOM CALL TO ACTION: PRONTO PARA COMEÇAR?                          */}
      {/* ===================================================================== */}
      <section className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-14 sm:py-20 text-center w-full">
        <div className="p-8 sm:p-12 rounded-3xl bg-surface border border-border shadow-elevated relative overflow-hidden flex flex-col items-center">
          {/* Ambient subtle glow */}
          ...
          <p className="mt-2.5 text-sm sm:text-base text-text-secondary max-w-md mx-auto leading-relaxed">
            Entre agora e descubra o que você pode preparar.
          </p>
      ...
      <footer className="py-6 border-t border-border bg-surface text-center text-xs text-text-secondary relative z-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-4 text-[11px]">
            <a href="#proposta" className="hover:text-primary transition-colors">O que é</a>
            <a href="#recursos-app" className="hover:text-primary transition-colors">Recursos</a>
            <button onClick={openAuthModal} className="hover:text-primary transition-colors cursor-pointer">
              Entrar agora
            </button>
          </div>
        </div>
      ...
      {/* ===================================================================== */}
      {/* MODAL / POPUP DE LOGIN SPATIAL UI                                     */}
      {/* ===================================================================== */}
      <AnimatePresence>
        {isAuthModalOpen && (
          <div
          ...
          >
            ...
            >
              ...
              {/* Form Content */}
              <div className="p-5 sm:p-6 flex-1 overflow-y-auto overscroll-contain space-y-4">
                ...
                {/* Security Note */}
                <div className="pt-3 border-t border-border flex items-start gap-2.5 text-[11px] text-text-secondary">
